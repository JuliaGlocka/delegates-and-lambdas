...
public sealed class DataSourceForTests
{
    ...
    public static IEnumerable<TestCaseData> DataForFindMaxTestForIntegers
    {
        get
        {
            yield return new TestCaseData(1, -20, new Comparison<int>((a, b) => a.CompareTo(b)), 1);
            yield return new TestCaseData(
                1,
                -20,
                new Comparison<int>((a, b) => Math.Abs(a).CompareTo(Math.Abs(b))),
                -20);
            yield return new TestCaseData(2_119, 2_787, new Comparison<int>((a, b) => a % 10 - b % 10), 2_119);
        }
    }
    ...
    public static IEnumerable<TestCaseData> DataForFindMaxTestForStrings
    {
        get
        {
            ...
            yield return new TestCaseData(
                "four",
                "six",
                new Comparison<string>((a, b) => a.Length.CompareTo(b.Length)),
                "four");
            yield return new TestCaseData(
                "Four",
                "six",
                new Comparison<string>((a, b) => string.Compare(a, b, StringComparison.OrdinalIgnoreCase)),
                "six");
            yield return new TestCaseData(
                "Four",
                "four",
    ...
    public static IEnumerable<TestCaseData> DataForFindMaxTestForDoubles
    {
        get
        {
            yield return new TestCaseData(0.0001, 12.456, new Comparison<double>((a, b) => a.CompareTo(b)), 12.456);
            yield return new TestCaseData(0.0001, -12.456, new Comparison<double>((a, b) => a.CompareTo(b)), 0.0001);
            yield return new TestCaseData(
                0.0001,
                -12.456,
                new Comparison<double>((a, b) => Math.Abs(a).CompareTo(Math.Abs(b))),
                -12.456);
        }
    }
